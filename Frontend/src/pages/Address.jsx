...
const Address = () => {
  ...
  return (
    <div className="">
      ...
      <div className="w-[79vw] py-2 px-10 mt-5 rounded bg-white">
      ...
      <div
        ...
        className="w-[73vw] mx-10 border my-5 rounded border-dashed border-green-500 flex justify-center items-center py-5 cursor-pointer"
      >
